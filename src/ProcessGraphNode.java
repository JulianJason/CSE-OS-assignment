...
public class ProcessGraphNode {
    ...
    private ArrayList<ProcessGraphNode> parents=new ArrayList<ProcessGraphNode>();
    //point to all the children
    private ArrayList<ProcessGraphNode> children=new ArrayList<ProcessGraphNode>();
    ...
    public synchronized boolean allParentsExecuted(){
        boolean ans=true;
        // segment below not necessary in ur implementation
